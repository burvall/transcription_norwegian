...
class ASR:
    def __init__(self):
        self.model_name = "NbAiLab/wav2vec2-1b-npsc-nst"
...
if __name__ == "__main__":
    st.set_page_config(
        page_title="Norwegian Transcription",
        page_icon="🎙️"
    )
    st.image(
    ...
    Norwegian transcripts for audio and video files. The speech-to-text model is Nasjonalbiblioteket AI Lab's wav2vec2-xlsr-300m-norwegian2 (C) with a 4-gram language model. If you have any questions - mail joachim@burvall.com
    """)
